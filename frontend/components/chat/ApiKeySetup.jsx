...
export function ApiKeySetup() {
        ...
        <Card className="border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-lg">
          <CardHeader className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-950/40 dark:to-purple-950/40 rounded-t-lg">
            ...
            <CardDescription className="text-slate-600 dark:text-slate-400">
              Please sign in to set up your OpenRouter API key.
            </CardDescription>
          </CardHeader>
        </Card>
      </div>
  ...
  return (
    <div className="container max-w-2xl mx-auto p-4">
      <Card className="border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-lg">
        <CardHeader className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-950/40 dark:to-purple-950/40 rounded-t-lg">
          <CardTitle className="text-slate-800 dark:text-slate-200">Set OpenRouter API Key</CardTitle>
          <CardDescription className="text-slate-600 dark:text-slate-400">
            To start chatting, please enter your OpenRouter API key. You can get
            one from{" "}
            <a
