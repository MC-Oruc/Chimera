...
export function ReplicateApiKeyModal({ isOpen, onClose, onApiKeyUpdated }) {
  ...
  const handleApiKeySubmit = async (e) => {
    ...
    try {
      await setReplicateApiKey(apiKeyInput.trim());
      setApiKeyInput("");
      onClose();
      toast.success("Replicate API key updated successfully");
            ...
            >
              ...
              >
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 mb-5">
                  Enter your Replicate API key to access AI image generation. You can get a key from{" "}
                  <a
